...
function runFunction(config, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        context.bindings.outLogTable = context.bindings.inLogQueue.items.map(x => (Object.assign({ PartitionKey: `${x.startTime}_${x.userInfo.sessionId}`, RowKey: `${x.userInfo.userId}_${x.time}` }, x)));
        context.log('DONE');
        context.done();
    });
}
